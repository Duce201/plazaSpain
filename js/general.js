function init() {
  ...
  $.getJSON('bd/general.json', houseOut);	
}

function houseOut (data) {
	// вывод на страницу
	console.log(data);
	 var out = '';
  	for(var key in data) {
...
jQuery(document).ready(function($){
    ...
    var city = $('#cities option:selected').html();
    var category = $('#catagories option:selected').html();
    var offer = $('#offers option:selected').html();
      console.log(city, category, offer);   
      // alert(city,category, offer);
      // alert(offer);
      // alert(category);
